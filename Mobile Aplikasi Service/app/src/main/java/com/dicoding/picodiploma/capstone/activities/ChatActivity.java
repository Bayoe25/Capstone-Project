...
import com.dicoding.picodiploma.capstone.adapters.ChatAdapter;
import com.dicoding.picodiploma.capstone.databinding.ActivityChatBinding;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendMessage(){
        ...
        message.put(Constants.KEY_MESSAGE, binding.inputPesan.getText().toString());
        message.put(Constants.KEY_TIMESTAMP, new Date());
        database.collection(Constants.KEY_COLLECTION_CHAT).add(message);
        binding.inputPesan.setText(null);
    }
