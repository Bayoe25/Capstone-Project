...
import com.dicoding.picodiploma.capstone.databinding.ActivityDaftarBinding;
...
public class DaftarActivity extends AppCompatActivity {
    ...
    private void setListeners(){
        ...
        binding.tombolDaftar.setOnClickListener(v -> {
            if(isValidDaftarDetails()){
                daftar();
            }
        });
    ...
    private void daftar(){
        ...
        user.put(Constants.KEY_NAME, binding.Nama.getText().toString());
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    preferenceManager.putString(Constants.KEY_NAME, binding.Nama.getText().toString());
    ...
    private Boolean isValidDaftarDetails(){
        if(encodedImage == null) {
            showToast("Masukan Foto Profil");
            return false;
        }else if(binding.Nama.getText().toString().trim().isEmpty()){
            ...
            return false;
        }else if(binding.inputKonfirmasiPassword.getText().toString().trim().isEmpty()){
            showToast("Konfirmasi Password");
            return false;
        }else if(!binding.inputPassword.getText().toString().equals(binding.inputKonfirmasiPassword.getText().toString())){
    ...
    private void loading(Boolean isLoading){
        if (isLoading){
            binding.tombolDaftar.setVisibility(View.INVISIBLE);
            binding.progressBar.setVisibility(View.VISIBLE);
        }else {
            binding.progressBar.setVisibility(View.INVISIBLE);
            binding.tombolDaftar.setVisibility(View.VISIBLE);
        }
    }
}